...
$Output = $VMHost | Group-Object -Property Build | 

    where count -lt $VMHost.count | 
    
    select @{l="ESXi Version";e={$_.group.ExtensionData.Summary.Config.Product.FullName[0]}},Count | 
    
    Sort-Object 'ESXi Version'
